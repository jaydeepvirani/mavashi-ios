...
//        cell.optionLabel.contentMode = UIViewContentMode.right
...
//        cell.optionLabel.frame = CGRect.init(x: cell.optionLabel.frame.origin.x, y: cell.optionLabel.frame.origin.x, width: cell.frame.size.width, height: cell.optionLabel.frame.size.height)
